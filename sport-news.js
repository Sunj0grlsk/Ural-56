...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const sportCategoryId = 1; // Замените на реальный ID категории "Спорт"
        const sportNews = allNews.filter(newsItem => 
            newsItem.CategoryID === sportCategoryId
        );
        
        console.log('Найдено спортивных новостей:', sportNews.length, sportNews);
