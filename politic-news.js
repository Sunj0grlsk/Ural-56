...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const politicCategoryId = 3; // Замените на реальный ID категории "Спорт"
        const politicNews = allNews.filter(newsItem => 
            newsItem.CategoryID === politicCategoryId
        );
        
        console.log('Найдено спортивных новостей:', politicNews.length, politicNews);
        
        // 3. Отображаем отфильтрованные новости
        displaySportNews(politicNews);
